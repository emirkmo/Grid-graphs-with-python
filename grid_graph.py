...
class Graph2D(Protocol):
    ...
    neighbors: Optional[dict[tuple[int, int], list[tuple[int, int]]]] = field(default_factory=dict)
    ...
    def get_neighbors(self, directions: DirectionProtocol) \
